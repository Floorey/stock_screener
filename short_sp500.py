...
def main():
    parser = argparse.ArgumentParser(description="Short S&P 500 index via SPY to hedge portfolio.")
    parser.add_argument(
        "--type", 
    ...
    hedger = MarketHedger("SPY")
    print(f"Executing S&P 500 Short Hedge using SPY (Type: {args.type.upper()}, Qty: {args.qty})...")
    ...
    if success:
        print("S&P 500 Short position placed successfully.")
    else:
        print("Error: S&P 500 Short position execution failed.")

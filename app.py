...
from qreport_ui import render_qreport_tab
...
from token_tracker_ui import render_token_tracker_tab
...
# Initialize Tabs
tab_bbg, tab1, tab_wl, tab_opt, tab_perf, tab2, tab_trade, tab_cash, tab_strat, tab_risk, tab_algo, tab3, tab_tok = st.tabs([
    "📟 Bloomberg Terminal",
    "🎯 Screener Dashboard", 
    "⭐ Watchlist Manager", 
    "🎫 Options-Screener",
...
# ----------------------------------------------------
# TAB 3: QUARTERLY REPORT ANALYZER (Q-REPORT)
# ----------------------------------------------------
with tab3:
    render_qreport_tab()
